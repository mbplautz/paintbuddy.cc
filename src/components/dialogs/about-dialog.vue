        ...
        <div class="about-dialog-window" @click="preventDefault($event)">
            <div class="content-panel">
                ...
                <div class="content">
                    ...
                    <div>Icons provided by <a href="https://fontawesome.com/">FontAwesome</a></div>
                </div>
                <div class="content">
                    <img src="https://material.io/resources/icons/static/ic_material_192px_light.svg" width="48" height="48" />
                    <div>and <a href="https://material.io/">Google Material Icons</a></div>
                </div>
                <div class="spacer"></div>
                <div>Flood fill algorithm by <a href="https://github.com/1j01/jspaint">Isaiah Odhner</a></div>
                <div>Color parse function by <a href="https://bl.ocks.org/jon-hall">Jon Hall</a></div>
                <div class="spacer"></div>
                <div class="content">
                    <svg class="octicon octicon-mark-github v-align-middle" height="48" viewBox="0 0 16 16" version="1.1" width="48" aria-hidden="true"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path></svg>
                    <div>PaintBuddy.cc is an Open Source Project. Check out the source code on <a href="https://github.com/mbplautz/paintbuddy.cc">GitHub</a>.</div>
                </div>
            </div>
            <div class="button-panel">
                <div class="button-span">
                    <div class="button ok-button" @click="hide()">
                        <a>
...
<script>
    ...
    export default {
        ...
        methods: {
           hide() {
                this.$root.$emit('hide-dialog', 'about-dialog');
            },
            preventDefault(e) {
                e.stopPropagation();
            }
...
<style>
    ...
    @media only screen and (max-width: 599px) {
        ...
        div.about-dialog-window div.content-panel {
            width: 300px;
        }
    }
    ...
    div.about-dialog-window div.button-panel {
        width: 100%;
        border-spacing: 10px;
        font-size: 20px;
    }

    div.about-dialog-window div.button-panel div.button-span {
        display: table;
        margin: 0 auto;
    }

    div.about-dialog-window div.button-panel div.button-span div.button {
        display: table-cell;
        color: #ffffff;
    ...
    div.about-dialog-window div.button-panel div.button-span div.button a {
        display: flex;
        align-items: center;
    }

    div.about-dialog-window div.button-panel div.button-span div.button a i {
        font-size: 36px;
        padding-right: 10px;
    }

    /* vestigial */
    div.about-dialog-window div.button-panel div.button-span div.cancel-button a i {
        color: #ff2d19;
    }

    div.about-dialog-window div.button-panel div.button-span div.ok-button a i {
        color: #258c1c;
    }    

    div.content-panel div.content {
        display: flex; 
        align-items: center;
        height: 48px;
    }

    div.content-panel div.content.header {
        height: 64px;
    }
    ...
    div.content-panel div.content img, div.content-panel div.content svg {
        margin-right: 16px;
    }
</style>